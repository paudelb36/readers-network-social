...
$username = $loggedIn ? $_SESSION['username'] : ''; // Get the username if logged in
?>
    ...
    <nav class="bg-white shadow-md fixed top-0 left-0 right-0 z-10">
        <div class="container mx-auto px-4 py-2 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="./friends.php" class="text-gray-600 hover:text-gray-900">Friends</a>
                <a href="#" class="text-gray-600 hover:text-gray-900">Messages</a>
                <a href="#" class="text-gray-600 hover:text-gray-900">Notifications</a>
            </div>
            <div class="relative">
